...
public class  ModifyProjectDemo {
	...
	private static void createUser()
	{
		try
		{
			...
			oPage.getUserName().sendKeys("Users");
	...
	private static void createProject()
	{
		try
		{
			...
			Thread.sleep(4000);
			oPage.getEnterProjectName().sendKeys("Project001");
			Thread.sleep(3000);
			oPage.getEnterCustomerNameForProject().sendKeys("Namita");
			Thread.sleep(3000);
	...
	private static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(5000);
			oPage.getModifyProjectDescription().sendKeys("This Proect is tested completely");
			Thread.sleep(5000);
			oPage.getCloseActionPageOfProject().click();
			Thread.sleep(5000);
