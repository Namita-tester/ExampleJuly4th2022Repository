...
public class ModifyProject {
	...
	private static void createProject() {
		try {
			...
			Thread.sleep(3000);
			oBrowser.findElement(By.xpath("//*[@id=\'projectPopup_projectDescriptionField\']")).sendKeys("This Project is tested by namita");
			Thread.sleep(2000);
	...
	private static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id='taskListBlock']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys("This Project is tested by namita in 2022");
			Thread.sleep(2000);
