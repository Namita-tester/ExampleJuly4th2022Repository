...
public class AnnotationDemo2UserModify {
	   ...
	   public static WebDriver oBrowser=null;
		...
		@Test(priority=3, dataProvider="modifyUser")
			private static void modifyUser(String str1)
			{
			try
			{
				...
				Thread.sleep(2000);
				oBrowser.findElement(By.xpath("//*[@id=\'userDataLightBox_firstNameField\']")).sendKeys(str1);
				Thread.sleep(2000);
				oBrowser.findElement(By.xpath("//*[@id=\'userDataLightBox_commitBtn\']/div/span")).click();
				Thread.sleep(5000);
			}catch(Exception e)
