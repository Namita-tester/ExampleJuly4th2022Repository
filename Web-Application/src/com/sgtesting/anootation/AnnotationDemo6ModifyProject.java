...
public class AnnotationDemo6ModifyProject{
	...
	@Test(priority=5,dataProvider="projectDescription")
	private static void modifyProject(String description)
	{
		try
		{
			oBrowser.findElement(By.xpath("//*[@id=\'cpTreeBlock\']/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[3]/div[3]")).click();
			Thread.sleep(3000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys(description);
			Thread.sleep(3000);
	...
	{
		return new Object[][] {{"Project1 has completed testing."}};
	}
}